...
public class BedrockWallBlock extends DiamondenrichedSteelModElements.ModElement {
	...
	public static class CustomBlock extends WallBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BedrockWallBlock.block, (int) (1)));
		}
	}
}
