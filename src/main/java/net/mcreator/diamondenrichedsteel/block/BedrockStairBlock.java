...
public class BedrockStairBlock extends DiamondenrichedSteelModElements.ModElement {
	...
	public static class CustomBlock extends StairsBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BedrockStairBlock.block, (int) (1)));
		}
	}
}
